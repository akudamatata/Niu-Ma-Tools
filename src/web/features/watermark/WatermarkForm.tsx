  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="space-y-3">
        ...
        <div
          className="flex w-full max-w-xl mx-auto flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-white/40 bg-white/5 px-6 py-8 text-center transition hover:border-white/70 hover:bg-white/10"
